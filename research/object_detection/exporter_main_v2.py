...
# ==============================================================================
# HNRS command: python exporter_main_v2.py --trained_checkpoint_dir=HNRS_training2 --pipeline_config_path=ssd_mobilenet_v2_fpnlite_320x320_coco17_tpu-8.config --output_directory=HNRS_inference2
